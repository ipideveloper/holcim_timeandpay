    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            If ViewState("pressed") = "" Then
                ...
                If ws.Validate_Duplicate_DateTime("", IIf(dplEmployee.SelectedIndex = 0, Current_User.Employee_ID, dplEmployee.SelectedValue), CType(txtdatefrom.Text, Date), CType(txtdateto.Text, Date), "OB") = True Then
                ...
                If txtpurposeoftravel.Text = "" Then
                    txtpurposeoftravel.Focus()
                    UserMsgBox("Purpose of Travel should not be blank!")
                    btnSave.Enabled = True
                    ViewState("pressed") = ""
                    Exit Sub
                End If
                ...
                If txtdestination.Text = "" Then
                    ...
                    UserMsgBox("Destination should not be blank!")
                    btnSave.Enabled = True
                    ViewState("pressed") = ""
                    Exit Sub
                End If

                If Len(Trim(txtpassport.Text)) = 0 And dpltravel_type.SelectedItem.Text = "" Then
                    UserMsgBox("Please fill-up the required fields.")
                    Exit Sub
                End If
...
#Region "Insert"
    ...
    Private Function insert_ob_header() As String
        ...
        End If
        Try
            ref_no = ws.Insert_OB_Header(IIf(dplEmployee.SelectedIndex = 0, Current_User.Employee_ID, dplEmployee.SelectedValue), dpltravel_type.SelectedItem.Text, txtpurposeoftravel.Text, _
                ...
                IIf(r_visa_no.Checked = True, "No", "Yes"), txtphone.Text, txtpassport.Text, txtphone.Text, IIf(r_dependent_no.Checked = True, False, True), _
...
#Region "Retrieve"
    ...
    Private Sub get_some_field(ByVal employee_id As String)
        Try
            Dim dr As DataRow, ds As DataSet = ws.Get_User_Info(employee_id)
    ...
    Private Sub get_employee_list()
        Try
            ...
            dplEmployee.Items.Insert(0, New ListItem(Current_User.LastName & " " & Current_User.FirstName, Current_User.Employee_ID))
            ...
            If r_dependent_no.Checked = True Then
    ...
    Protected Sub lnk_add_travel_allowance_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnk_add_travel_allowance.Click
...
#Region "Manage"
    ...
    Private Sub send_notifications(ByVal ref_no As String, ByVal employee_name As String)
        ...
        body = employee_name & " is applying for " & " OFFICIAL BUSINESS/TRAVEL ORDER. Please see Ref. " & ref_no & " <br><br><br><br> This is a system-generated message.  Do not reply to this message."
        ...
        'Else
        If r_level = "USER_FINAL" Then
            level = "FINAL"
            'Removed Requested by Orly/Ching June 28, 2012 3:17:11 PM GMT+08:00
        Else
            level = "FINAL"
        End If
...
#End Region
    ...
    Protected Sub r_dependent_yes_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles r_dependent_yes.CheckedChanged
        'Code Added by Andrew 11-08-2011 start
        If r_dependent_yes.Checked = True Then
            txtdependentname1.BackColor = Drawing.Color.Yellow
            txtdepage1.BackColor = Drawing.Color.Yellow
            txtdeppass1.BackColor = Drawing.Color.Yellow
        Else
            ...
            txtdeppass1.BackColor = Drawing.Color.White
        End If
        'Code Added by Andrew 11-08-2011 End
    End Sub

    Protected Sub r_dependent_no_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles r_dependent_no.CheckedChanged
        'Code Added by Andrew 11-08-2011 start
        If r_dependent_no.Checked = True Then
            txtdependentname1.BackColor = Drawing.Color.White
            txtdepage1.BackColor = Drawing.Color.White
