    ...
    Private Sub Import_To_Grid(ByVal FilePath As String, ByVal Extension As String, ByVal isHDR As String)
        ...
        Try
            ...
            For i As Integer = 0 To GridView1.Rows.Count - 1
                ...
                Dim Purpose As String = GridView1.Rows(i).Cells(7).Text
    ...
    Protected Sub btnConfirmUpload_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnConfirmUpload.Click
        ...
        Try
            For i As Integer = 0 To GridView1.Rows.Count - 1
                ...
                spWeb_Insert_OB_Header_Concur(RequestID, EmployeeID, Purpose, StartDate, EndDate, EmployeeID, ApprovalStatus)
            Next
