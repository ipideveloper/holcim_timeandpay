<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="oncall_edit_form.aspx.vb" Inherits="oncall_edit_form" title="Untitled Page" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <table style="width: 737px; text-align: left">
                ...
                <tr style="color: #000000">
                    <td style="width: 118px; height: 16px">
                        Employee Name :</td>
                    <td colspan="2" style="font-size: 15pt; color: red; height: 16px; width: 366px;">
                ...
                <tr style="font-weight: bold; color: #000000">
                    <td style="width: 118px">
                        Date :</td>
                    <td colspan="2" style="font-weight: normal; height: 16px; width: 366px;">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="height: 16px; width: 366px;">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="width: 366px; height: 16px">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="height: 16px; width: 366px;"><asp:TextBox id="txt_contact_by" runat="server" Font-Size="8pt" tabIndex="2" Width="355px" MaxLength="50" BackColor="#FFFFC0"></asp:TextBox>
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="vertical-align: top; width: 366px;">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="3" style="color: white; border-bottom: gray 1px solid; height: 16px">
                        ...
                        <asp:Button ID="BtnSaveExtend" runat="server" BackColor="Red" BorderColor="DarkGray"
                            BorderWidth="1px" Font-Names="arial" Font-Size="8pt" ForeColor="White" Text="Update w/ Extended On Call"
