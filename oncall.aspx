<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="oncall.aspx.vb" Inherits="oncall" Title="Holcim - On Call" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Button ID="btnApply" runat="server" BackColor="Red" BorderColor="DarkGray" BorderWidth="1px"
        Font-Names="arial" Font-Size="8pt" ForeColor="White" OnClick="btnApply_Click"
        Text="Apply" Width="87px" CssClass="Buttonhand1hover" />
    <table style="width: 100%">
        <tr>
            ...
            <td style="width: 136px">
                <asp:DropDownList ID="DpOncall" runat="server" Visible="false" EnableViewState="False">
                    <asp:ListItem Value="employee_name">Employee Name</asp:ListItem>
                    <asp:ListItem Value="employee_id">Personnel Number</asp:ListItem>
                    <asp:ListItem Value="work_date">Requested Date and Time</asp:ListItem>
                    <asp:ListItem Value="date_created">Date Filed</asp:ListItem>
                    <asp:ListItem>Status</asp:ListItem>
                </asp:DropDownList>
            </td>
            <td>
                <asp:Button ID="BtnOnCallSort" runat="server" Text="Sort" Visible="false" EnableViewState="False"/>
            </td>
        </tr>
    </table>
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
            ...
            <Columns>
                <asp:TemplateField HeaderText="...">
                    <ItemTemplate>
                        <asp:LinkButton ID="lnk_edit_oncall" runat="server" CommandName="cmd_edit_oncall"
                            ForeColor="Red" Text='<%# bind("isedit") %>'></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="employee_name" HeaderText="Employee Name" SortExpression="employee_name"></asp:BoundField>
                <asp:BoundField DataField="employee_id" HeaderText="Personnel No." SortExpression="employee_id"></asp:BoundField>
                <asp:BoundField DataField="work_date" HeaderText="Requested Date and Time" SortExpression="work_date"></asp:BoundField>
                <asp:BoundField DataField="date_created" HeaderText="Date Filed" SortExpression="date_created"></asp:BoundField>
