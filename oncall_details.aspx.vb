...
#Region "Initialization"
    ...
    Private Sub Initialize()
        get_oncall_details(Request.QueryString("ref_no"))
    End Sub
...
#Region "Retrieve"
    ...
    Private Sub get_oncall_details(ByVal ref_no As String)
        ...
        With dr
            ...
            txt_date_covered.Text = dr("work_date")
            txt_contacted_by.Text = dr("contacted_by")
            txt_date_filed.Text = dr("date_created")
            txt_reason.Text = dr("details")
