<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="ob_edit_form.aspx.vb" Inherits="ob_edit_form" Title="Holcim - OB Application" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 740px; text-align: left">
        <tr style="color: #000000">
            <td colspan="5" style="color: gray; height: 16px; font-weight: bold; border-bottom: gray 1px solid;">
        ...
        <tr style="color: #000000">
            <td colspan="5" style="font-weight: bold; color: gray; border-bottom: gray 1px solid;
                ...
                <asp:Label ID="lbl_date_filed" runat="server" ForeColor="Black" Text="Label" Width="123px"></asp:Label><span
                    ...
                    &nbsp; Status: &nbsp; &nbsp;</span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp;
                <asp:Label ID="lbl_status" runat="server" ForeColor="Black" Text="Label" Width="136px"></asp:Label>
            </td>
        </tr>
        <tr style="color: #000000">
            ...
            <td colspan="2" style="height: 16px; width: 376px;">
                <asp:DropDownList ID="dplEmployee" runat="server" Font-Size="8pt" Width="211px" BackColor="#FFFFC0"
            ...
            <td colspan="1" style="height: 16px">
                <asp:TextBox ID="txtcontactno" runat="server" Font-Size="8pt" Width="126px" BackColor="#FFFFC0"></asp:TextBox>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ControlToValidate="txtcontactno"
                    Font-Bold="False" Font-Size="1pt" ValidationGroup="Val"></asp:RequiredFieldValidator>
                <cc1:MaskedEditExtender ID="MaskedEditExtender1" runat="server" Mask="9999999999999999999"
                    MaskType="Number" TargetControlID="txtcontactno">
        ...
        <tr style="color: #000000">
            ...
            <td colspan="1" style="height: 16px">
                <asp:TextBox ID="txtcostcenter" runat="server" Font-Size="8pt" Width="126px" BackColor="#FFFFC0"></asp:TextBox>
        ...
        <tr style="color: #000000">
            ...
            <td colspan="2" style="height: 16px; width: 376px;">
                <asp:TextBox ID="txtpurposeoftravel" runat="server" Font-Size="8pt" Width="324px"
                    TextMode="MultiLine" BackColor="#FFFFC0"></asp:TextBox><asp:RequiredFieldValidator
        ...
        <tr style="color: #000000">
            ...
            <td colspan="2" style="vertical-align: top; width: 376px;">
                from
                <asp:TextBox ID="txtdatefrom" runat="server" Font-Size="8pt" Width="91px" BackColor="#FFFFC0"
                ...
                <asp:TextBox ID="txtdateto" runat="server" Font-Size="8pt" Width="91px" BackColor="#FFFFC0"
                    CssClass="Buttonhand1hover"></asp:TextBox>
        ...
        <tr style="color: #000000">
            ...
            <td colspan="2" style="vertical-align: top; width: 376px;">
                <asp:TextBox ID="txtdestination" runat="server" Font-Size="8pt" Width="341px" BackColor="#FFFFC0"></asp:TextBox><asp:RequiredFieldValidator
                    ID="RequiredFieldValidator29" runat="server" ControlToValidate="txtpurposeoftravel"
                    ErrorMessage="PURPOSE OF TRAVEL cannot be blank.  Please enter purpose of travel."
                    Font-Size="Large" SetFocusOnError="True" ValidationGroup="ValG">*</asp:RequiredFieldValidator>
            </td>
            <td colspan="1" style="vertical-align: top; width: 72px">
        ...
        <tr style="color: #000000">
            ...
            <td colspan="2" style="vertical-align: top; height: 16px; width: 376px;">
            </td>
        ...
        <tr style="color: #000000">
            <td style="height: 16px; color: gray; font-weight: bold; border-bottom: gray 1px solid;"
                colspan="5">
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        <asp:TemplateField>
                            ...
                            <HeaderStyle Font-Size="11px" Width="42px" />
                        </asp:TemplateField>
        ...
        <tr style="color: #000000">
            <td style="font-weight: bold; color: gray; border-bottom: gray 1px solid;" colspan="5">
            ...
            <td colspan="5">
                <asp:GridView ID="gv_lodging" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Accommodation_Type" HeaderText="Accommodation Type" HeaderStyle-Font-Size="11px" />
                        <asp:BoundField DataField="preferred_hotel" HeaderStyle-Font-Size="11px" HeaderText="Preferred Hotel" HtmlEncode="False"
                            NullDisplayText="-" />
                        <asp:BoundField DataField="check_in" HeaderStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Center" HeaderText="Check In" />
                        <asp:BoundField DataField="check_out" HeaderStyle-Font-Size="11px" ItemStyle-HorizontalAlign="Center" HeaderText="Check Out" />
                    </Columns>
                    <FooterStyle BackColor="#FFFFCC" ForeColor="#330099" />
                    <PagerStyle BackColor="#FFFFCC" ForeColor="#330099" HorizontalAlign="Center" />
                    <SelectedRowStyle BackColor="#FFCC66" Font-Bold="True" ForeColor="#663399" />
        ...
        <tr style="color: #000000">
            <td colspan="5" style="font-weight: bold; color: gray; border-bottom: gray 1px solid;">
                ...
                <asp:LinkButton ID="lnk_add_travel_allowance" runat="server" Font-Bold="True" ForeColor="Red">[ Add ]</asp:LinkButton>
            </td>
        </tr>
        <tr style="color: #000000">
                            ...
                            <asp:GridView ID="gv_cash_advance" runat="server" AutoGenerateColumns="False" BackColor="White"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        ...
                                        <HeaderStyle Width="42px" Font-Size="11px" />
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="purpose" HeaderStyle-Font-Size="11px" HeaderText="Purpose of Cash Advance">
        ...
        <tr style="color: #000000">
            <td colspan="5" style="vertical-align: top; height: 16px">
            </td>
        </tr>
        <tr style="color: #000000">
            <td colspan="5" style="font-weight: bold; color: gray; border-bottom: gray 1px solid">
        ...
        <tr style="color: #000000">
            <td colspan="5" style="color: white; border-bottom: gray 1px solid; height: 17px">
                .
            </td>
        </tr>
        <tr style="color: #000000">
            <td colspan="5" style="border-bottom-width: 1px; border-bottom-color: gray; color: white;
                height: 50px">
                <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server" ConfirmOnFormSubmit="True"
                    ConfirmText="Are you sure you want to change this form?" TargetControlID="btnSave">
                ...
                <%--                <asp:Button id="btnSave" runat="server" BackColor="Red" BorderColor="DarkGray" BorderWidth="1px"
                    ...
                    Width="87px" OnClick="btnSave_Click" CssClass="Buttonhand1hover" CausesValidation="False" UseSubmitBehavior="False" />--%>
                <asp:Button ID="btnSave" runat="server" BackColor="Red" BorderColor="DarkGray" BorderWidth="1px"
                    Font-Names="arial" Font-Size="8pt" ForeColor="White" Text="Update" ValidationGroup="ValG"
    ...
    <!--Begin Lodging-->
    <asp:Panel ID="Panel3" runat="server" Height="300px" Width="507px" BackColor="White" BorderColor="Black">
            ...
            <center>
                <table style="width: 450px; text-align: left">
                    ...
                    <tr style="color: #000000">
                        ...
                        <td style="vertical-align: top; width: 304px;">
                           <%-- <asp:TextBox ID="txtpreferredhotel" runat="server" Font-Size="8pt" Width="259px"></asp:TextBox>--%>
            ...
            <table style="width: 450px; text-align: left">
                ...
                <tr style="color: #000000">
                    ...
                    <td style="height: 16px; width: 322px;">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="txttranspodate"
                ...
                <tr style="color: #000000">
                    ...
                    <td style="vertical-align: top; width: 322px;">
                        ...
                        <cc1:MaskedEditExtender ID="MaskedEditExtender4" runat="server" AcceptAMPM="True"
                            Mask="99:99:99" MaskType="Time" TargetControlID="txtpickup">
                        </cc1:MaskedEditExtender>
                    </td>
                </tr>
                <tr style="color: #000000">
