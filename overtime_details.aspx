<%@ Page Language="VB" AutoEventWireup="false" CodeFile="overtime_details.aspx.vb" Inherits="overtime_details" %>
...
<body style="font-size: 8pt; font-family: arial">
    ...
    <div>
        ...
        <input id="Button1" type="button" value="Close Window" style=" background-color:Red; border:1px solid DarkGray; font-size:8pt; color:#FFFFFF; width:87px;" class="Buttonhand1hover" onclick="self.close()" />
        </center>
