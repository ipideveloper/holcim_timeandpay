<%@ Page Language="VB" EnableViewState="false" AutoEventWireup="false" CodeFile="ForgotPassword.aspx.vb" Inherits="admin_ForgotPassword" %>
    ...
    <fieldset>
			<section><label for="username">Username <asp:RequiredFieldValidator ID="RequiredFieldValidator1" EnableViewState="false" runat="server" ErrorMessage="*" ControlToValidate="username" Display="Dynamic" Enabled="false"></asp:RequiredFieldValidator></label>
				<div><asp:TextBox ID="username" runat="server" ></asp:TextBox></div>
			        ...
			        <div style="float:left; padding-left:15px;padding-top:10px;"><asp:Label ID="ForgotPasswordMessage" runat="server"/></div>
					<div style="float:right"><asp:Button ID="RetrievePasswordButton" runat="server" Text="Retrieve Password"></asp:Button>&nbsp;<asp:Button ID="BackButton" runat="server" Text="Back" /></div>
			</fieldset>
	</ContentTemplate>
    </asp:UpdatePanel>		
    </form>
