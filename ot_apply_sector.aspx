<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ot_apply_sector.aspx.vb" Inherits="ot_apply_sector" title="Holcim - OT/ESD Application" %>
            ...
            <table style="width: 739px; text-align: left">
                ...
                <tr style="font-weight: bold; color: #000000">
                    ...
                    <td colspan="2" style="font-weight: normal; width: 362px;">
                        ...
                        <asp:DropDownList ID="dplFrom" runat="server" BackColor="#FFFFC0" 
                        ...
                        </asp:DropDownList><asp:ListBox ID="lstFrom" runat="server" Rows="1" 
                        ...
                        </asp:ListBox><asp:ListBox ID="ampmFrom" runat="server" Rows="1" 
                            BackColor="#FFFFC0" CssClass="Buttonhand1hover" AutoPostBack="True">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="width: 362px">
                        <asp:DropDownList ID="dplTo" runat="server" BackColor="#FFFFC0" 
                            CssClass="Buttonhand1hover" AutoPostBack="True">
                            <asp:ListItem Value="01"></asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            <asp:ListItem Value="03"></asp:ListItem>
                            ...
                            <asp:ListItem Value="11"></asp:ListItem>
                            <asp:ListItem Value="12"></asp:ListItem>
                        </asp:DropDownList><asp:ListBox ID="lstTo" runat="server" Rows="1" 
                            BackColor="#FFFFC0" CssClass="Buttonhand1hover" AutoPostBack="True">
                            <asp:ListItem>00</asp:ListItem>
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            ...
                            <asp:ListItem>58</asp:ListItem>
                            <asp:ListItem>59</asp:ListItem>
                        </asp:ListBox><asp:ListBox ID="ampmTo" runat="server" Rows="1" 
                            BackColor="#FFFFC0" CssClass="Buttonhand1hover" AutoPostBack="True">
                            <asp:ListItem Value="PM">PM</asp:ListItem>
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="1" style="vertical-align: bottom; width: 531px; text-align: right">
                        ...
                        &nbsp; &nbsp;<asp:Button ID="BtnSaveExtend" runat="server" BackColor="Red" BorderColor="DarkGray" BorderWidth="1px"
                            Font-Names="arial" Font-Size="8pt" ForeColor="White" Text="Add w/ Extended OT/ESD" ValidationGroup="ValG"
