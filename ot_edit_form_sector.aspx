<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="ot_edit_form_sector.aspx.vb" Inherits="ot_edit_form_sector" title="Holcim - OT/ESD Application" %>
            ...
            <table style="width: 739px; text-align: left">
                ...
                <tr style="font-weight: bold; color: #000000">
                    ...
                    <td colspan="2" style="font-weight: normal; width: 362px;">
                        ...
                        </asp:DropDownList><asp:ListBox ID="lstFrom" runat="server" Rows="1" BackColor="#FFFFC0" CssClass="Buttonhand1hover">
                ...
                <tr style="color: #000000">
                    ...
                    <td colspan="2" style="width: 362px">
                        <asp:DropDownList ID="dplTo" runat="server" BackColor="#FFFFC0" CssClass="Buttonhand1hover">
                            ...
                            <asp:ListItem Value="11"></asp:ListItem>
                            <asp:ListItem Value="12"></asp:ListItem>
                        </asp:DropDownList><asp:ListBox ID="lstTo" runat="server" Rows="1" BackColor="#FFFFC0" CssClass="Buttonhand1hover">
                            <asp:ListItem>00</asp:ListItem>
                            <asp:ListItem>01</asp:ListItem>
                            <asp:ListItem>02</asp:ListItem>
                            <asp:ListItem>03</asp:ListItem>
